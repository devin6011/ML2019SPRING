...
model.fit_generator(datagen.flow(X_train, y_train, batch_size=bs), steps_per_epoch=np.ceil(X_train.shape[0] / bs), epochs=100, validation_data=(X_val, y_val), callbacks=[lr_reducer, early_stopper])
